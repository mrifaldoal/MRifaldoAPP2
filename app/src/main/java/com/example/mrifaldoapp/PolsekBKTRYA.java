...
public class PolsekBKTRYA extends ListActivity {
    ...
    private void tampilkanpilhan(String pilhan) {
        try {
            ...
            if (pilhan.equals("Call Center")){
                String nomortel ="tel: (0761) 674755";
                a = new Intent(Intent.ACTION_DIAL, Uri.parse(nomortel));

            } else if (pilhan.equals("Driving Direction"))
            {
                String lokasirs = "https://goo.gl/maps/Ys4UQTw3RYLBSwT8A";
                a = new Intent(Intent.ACTION_VIEW,Uri.parse(lokasirs));

            } else if (pilhan.equals("Website"))
            {
                String web = "https://www.liputan6.com/tag/polsek-bukitraya";
                a = new Intent( Intent.ACTION_VIEW,Uri.parse(web));

            } else if (pilhan.equals("Info di Google"))
            {
                a = new Intent(Intent.ACTION_WEB_SEARCH);
                a.putExtra(SearchManager.QUERY,"Polsek Bukir Raya");
